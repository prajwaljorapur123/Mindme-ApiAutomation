	...
	//	@Test(priority = 1)
		public void AdminCreateCompany() {
			...
			if (response.getStatusCode() == 200
					&& response.jsonPath().getString("message").equals("200 OK")) {
		...
		public void AdminSearchCompany() {
			...
			Response response = AdminCompanyEndpoints.AdminCompanySearch(AdminTest.AdminLoginToken, this.SearchCompany.getName(),this.SearchCompany.getPageNo(),this.SearchCompany.getPageSize(),this.SearchCompany.getSearchType());
			response.prettyPrint();
			
			CompanyId = response.jsonPath().getInt("data[1].id");
		...
		//Admin update Company
				...
				public void AdminUpdateCompany() {
					...
					UpdateCompany.setCompanyName("trudosys");
					...
					Response response = AdminCompanyEndpoints.AdminUpdateCompany(AdminTest.AdminLoginToken , CompanyId , UpdateCompany);
					response.prettyPrint();
